          ...
          {success ? (
            ...
            >
                <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 flex flex-col items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-emerald-500 font-black uppercase text-xs tracking-widest mb-1">Transmission Sent</h3>
                        <p className="text-[10px] font-medium text-slate-500">Check your inbox for the recovery token.</p>
                    </div>
                </div>
                
                <button 
                    onClick={() => navigate('/reset-password')}
                    className="w-full py-4 rounded-xl border border-dashed border-slate-500/30 text-slate-500 hover:text-cyan-500 hover:border-cyan-500/50 text-xs font-bold uppercase tracking-widest transition-all"
                >
                    I have the token →
                </button>
            </motion.div>
